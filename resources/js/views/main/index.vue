          ...
          <div class="banner-slide3 slick" data-slick='{"dots": true, "infinite": true, "speed": 600, "slidesToShow": 1,
            ...
            <div class="slide">
              <div class="contant-box position-relative">
                ...
                <img class="bg-img hundread-vh" src="/assets/images/home-three/banner_02.jpg" alt="image">
            ...
            <div class="slide">
              <div class="contant-box position-relative">
                ...
                <img width="100%" class="bg-img hundread-vh" src="/assets/images/home-three/3.png" alt="image">
                ...
                <div  class="product-slider-main position-relative ">
                  <div   class="product-slider__single text-center">
                    <div
                      ...
                      <div class="img-box">
                        <img src="http://127.0.0.1:8000/storage/images/hxSS1GyPR5iBJydYKrYx25mdTE2VBgZdZ58GefK1.png" alt="" />
                      </div>
                      <div class="content-box mt-10"> <span>DS-2CD2443G0-IW</span>
                        <h2>6500₽</h2>
                        <h5>Год гарантии</h5>
                        <div class="btn-box"> <a href="/products"
                                                 class="btn--primary style2">Подробнее</a> </div>
                      </div>
                    </div>
                  </div>
    ...
    methods:{
        ...
        getProductsCam(page=1){
            this.axios.post('/api/products',{
                ...
                .then(res=>{
                    this.productsCam = res.data.data
                    this.pagination = res.data.meta
                    console.log(res.data.data);
