                        ...
                        <div v-for="product in products"  class="col-xl-4 col-lg-6 col-6 ">
                          <div class="products-three-single w-100  mt-30">
                            ...
                            <div class="products-three-single-content text-center"> <span></span>
                              <h5>
                                <router-link :to="{name: 'service.show',params:{id: product.id}}">{{product.title}} </router-link>
                              </h5>
...
data(){
  ...
  methods: {
    ...
    addToWishlist(id,title,image_url,price){
    ...
    getFilterList(){
      this.axios.get(`/api/service/filters`)
          .then(res=>{
