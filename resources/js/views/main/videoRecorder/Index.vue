                                                ...
                                                <div v-for="product in products"  class="col-xl-4 col-lg-6 col-6 ">
                                                    <div class="products-three-single w-100  mt-30">
                                                        <div class="products-three-single-img">
                                                            <a  href="shop-details-3.html" class="d-block"></a>
                                                                <router-link :to="{name: 'recorder.show',params:{id: product.id}}">
                                                                        ...
                                                                        <div class="quick-view__left-content" >
                                                                            <div class="tabs">
                                                                                <div class="popup-product-thumb-box">
                                                                                    <ul>
                                                                                        <li v-for="cameraImage in popupProduct"
                                                                                            class="tab-nav popup-product-thumb">
                                                                                            <a :href="`#tabb1${cameraImage.id}`" >
                                                                                                <img :src="cameraImage.image_url"
                                                                                                     alt="" /> </a> </li>
                                                                                    </ul>
                                                                                </div>
                                                                                <div class="popup-product-main-image-box">
                                                                                    <div v-for="cameraImage in popupProduct"  :id="`tabb1${cameraImage.id}`"
                                                        ...
                                                        <div class="products-three-single-content text-center"> <span>{{product.category.title}}</span>
                                                            <h5>
                                                                <router-link :to="{name: 'recorder.show',params:{id: product.id}}">{{product.title}} </router-link>
                                                            </h5>
                                ...
                                <div class="sidebar-holder">
                                    ...
                                    <div class="single-sidebar-box mt-30 wow fadeInUp animated ">
                                        ...
                                        <div class="checkbox-item">
                                            <form>
                                                <div v-for="channel in filterList.channels" class="form-group"> <input :value="channel.id"  v-model="channels" type="checkbox" :id="channel.id"> <label
                                                    :for="channel.id">{{channel.title}} Канальный</label> </div>
                                            </form>
                                        </div>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        getProduct(id){
            this.axios.get(`api/recorder/${id}`)
                .then(res=>{
        ...
        getFilterList(){
            this.axios.get(`/api/recorder/filters`)
                .then(res=>{
